export const style = 'width: 75vw; height: 80vh;border-radius: 30px; border: 1px solid #009150; box-shadow: 0px 0px 5px 0px #04cf74 '

export const textInput = {
  placeholder: { text: 'Haz tu consulta', style: { color: '#009150' } },
  styles: {
    container: {
      height: '70px',
      width: '90%',
...
export const messageStyles = {
  default: {
    ...
    user: { bubble: { backgroundColor: '#009150' } },
    ai: { bubble: { backgroundColor: '#dff7df', color: 'black' } },
  },
  loading: {
    message: {
      styles: {
